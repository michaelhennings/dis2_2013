...
public class SimpleWindow {
  ...
  /**
   * The window area of this window defined in terms of it's parents coordinate
   * system.
   */
  RectangleF windowArea;

  /**
   * The actual pixel area on the desktop which is covered by this window. This
   * is used by the drawing context to make drawing easier. Needs to be
   * recalculated whenever the size or position of the window changes.
   */
  ...
  /**
   * All drawing commands should be called here. This method is supposed to be
  ...
  public void addChild(SimpleWindow simpleWindow) {
    if (simpleWindow == this) {
      throw new IllegalArgumentException("Cannot add a window to itselft!");
    }
