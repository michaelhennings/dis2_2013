...
//    createBufferStrategy(2);
  ...
  protected RectangleI getTextSize(String text) {
    Rectangle2D bounds = getFont().getStringBounds(text, getGraphics().getFontMetrics(getFont()).getFontRenderContext());
    return new RectangleI(0, 0, (int) bounds.getWidth(), (int) bounds.getHeight());
  }
