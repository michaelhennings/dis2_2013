...
public final class CoordinateMath {
  ...
  /**
   * Transforms a point from coordinate system A to coordinate system B where B
   * is defined in terms of A (Parent -> Child).
   */
  ...
  /**
   * Transforms a point from coordinate system A to coordinate system B where A
   * is defined in terms of B (Child -> Parent).
   */
